...
portefeuille_y= yield_to_mat_cash_flow(f_cashflow, 1, fprime_cashflow,                                        (portefeuille_cashflow, prix_portefeuille))
...
french_data2= french_data[np.logical_and(french_data["Maturity"] <= 8,                                         french_data["Maturity"] >= 1)].reset_index(drop= True, inplace= False)
germany_data2= germany_data[np.logical_and(germany_data["Maturity"] <= 8,                                         germany_data["Maturity"] >= 1)].reset_index(drop= True, inplace= False)
